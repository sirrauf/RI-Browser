...
Partial Class AboutApp
    ...
    Private Sub InitializeComponent()
        ...
        Me.label1.Text = "Tech Source Code Store ialah toko source code aplikasi untuk kebutuhan bisnis, ya" &
    "ng dimana Owner dan Foundernya ialah Ananda Rauf Maududi, berasal dari siswa SMK" &
    " Bina Pendidikan 2 Kab.Bogor"
        '
        'imgDonate
        '
